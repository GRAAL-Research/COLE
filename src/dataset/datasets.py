...
datasets = {
  ...
  "opus_parcus ": Dataset(
        ...
        .add_data(line["sent1"]).add_data(line["sent2"])
        .add_end(
            (
    ...
    "piaf ": Dataset(
        ...
        line_to_prompt_fn=lambda line: PromptBuilder()
        .add_premise("Voici une question et un contexte. Où, dans le texte, commence la réponse à la question ?")
        .add_data(
            f"Contexte    : {line['Contexte']}\n"
  ...
  "sickfr ": Dataset(
    ...
    "sts22 ": Dataset(
        ...
        .add_data(
            f"sentence 1    : {line['sentence 1']}\n"
            f"sentence 2: {line['sentence 2']}"
        )
        .add_end(
            (
        ...
        .build(),
        line_to_data_fn=lambda line: {
            "sentence 1 ": line["sentence 1 "],
            "sentence 2 ": line["sentence 2 "]
        },
    ),
    "xnli ": Dataset(
        "xnli",
